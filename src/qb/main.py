...
def visit_player_page(name,url):
    ...
    if(num_rows > 1):        
        for i in range(num_rows-1):
            ...
            passing_yds = next_year_row['Passing Yds'].unique()[0] * POINTS_PER_PASS_YD
            passing_td =  next_year_row['Passing TD'].unique()[0] * POINTS_PER_PASS_TD
            picks = next_year_row['Int'].unique()[0] * POINTS_PER_PASS_INT
